    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <fildset>
                ...
                <form action="http://<?php echo APP_HOST; ?>/ContasReceber/salvar" method="post" id="form_cadastro" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="quantidade">Data de compensação</label>
                    ...
                    <div class="row">
						<div class="col-md-5">
                            <div class="form-group">
                                <label for="lucro_real">Lucro Real</label>
                                <input type="checkbox" name="lucro_real" value="lucro_real" >
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="form-group">
